...
Table with the cohort dimensions
...
Filtering and normalization. The coefficient of variation is also shown
...
Estimation of the number of latent factors and modification of the full
and null matrices
...
Enrichment analysis with Gene Ontology (GO)
...
The work is parallelized to speed up the analysis.

...
In order to visualyze if the samples have LOY or not, I perform a plot that shows the LORR of each SNP of the sample and the theoretical LRRs. The expected LRR is in 0 but when and individual has LOY, the LRR is lower-
